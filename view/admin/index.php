                    ...
                    <li class="nav-item p-2">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                <a class="dropdown-item p-2" href="../view/create_produk.php">Jumlah Keseluruhan</a>
                                <a class="dropdown-item p-2" href="../view/create_pelanggan.php">Jumlah per provinsi</a>
                                <a class="dropdown-item p-2" href="../view/create_merk.php">Statistik Jumlah</a>
                            </div>
                        </div>
                    </li>
                    <li class="nav-item p-2">
